  ...
  private func js_three_loadLibrary(_ callbackID: Int32)
  ...
  public func three_createPerspectiveCamera(fov: Double, aspect: Double, near: Double, far: Double)
    -> Int32

  @_extern(wasm, module: "env", name: "three_createOrthographicCamera")
  public func three_createOrthographicCamera(
    left: Double, right: Double, top: Double, bottom: Double, near: Double, far: Double
  ) -> Int32
  ...
  public func three_setRendererSize(
    _ rendererID: Int32, width: Int32, height: Int32, pixelRatio: Double)
  ...
  public func three_getWorldPosition(_ objectID: Int32, buffer: UnsafeMutablePointer<Double>)
    -> Bool
  ...
  private func js_three_getName(
    _ objectID: Int32, _ bufferPointer: UnsafeMutablePointer<CChar>, _ bufferLen: Int32
  ) -> Int32
  ...
  private func js_three_getObjectByName(
    _ sceneID: Int32, _ namePointer: UnsafePointer<CChar>, _ nameLen: Int32
  ) -> Int32
  ...
  private func js_three_loadGLTF(
    _ urlPointer: UnsafePointer<CChar>, _ urlLen: Int32, _ callbackID: Int32)
  ...
  private func js_three_loadUSDZ(
    _ urlPointer: UnsafePointer<CChar>, _ urlLen: Int32, _ callbackID: Int32)
  ...
  public func three_traverseScene(
    _ sceneID: Int32, meshBuffer: UnsafeMutablePointer<Int32>, bufferSize: Int32
  ) -> Int32
  ...
  public func three_computeBoundingBox(_ objectID: Int32, buffer: UnsafeMutablePointer<Double>)
    -> Bool
  ...
  private func js_three_createShaderMaterial(
    _ vertexShaderPtr: UnsafePointer<CChar>, _ vertexShaderLen: Int32,
    _ fragmentShaderPtr: UnsafePointer<CChar>, _ fragmentShaderLen: Int32, _ textureID: Int32
  ) -> Int32

  public func three_createShaderMaterial(
    vertexShader: String, fragmentShader: String, textureID: Int32
  ) -> Int32 {
    return vertexShader.withCString { vertexPtr in
      fragmentShader.withCString { fragmentPtr in
        js_three_createShaderMaterial(
          vertexPtr, Int32(vertexShader.utf8.count), fragmentPtr, Int32(fragmentShader.utf8.count),
          textureID)
      }
    }
  }
  ...
  private func js_getDevicePixelRatio() -> Float
  ...
  private func js_getMouseX_raw(_ eventPtr: UnsafePointer<CChar>, _ eventLen: Int32) -> Double

  @_extern(wasm, module: "env", name: "event_clientY")
  private func js_getMouseY_raw(_ eventPtr: UnsafePointer<CChar>, _ eventLen: Int32) -> Double
  ...
  private func js_getEventKey_raw(
  ...
  public enum three {
    ...
    public static func createPerspectiveCamera(
      fov: Double, aspect: Double, near: Double, far: Double
    ) -> Int32 {
      three_createPerspectiveCamera(fov: fov, aspect: aspect, near: near, far: far)
    }
    public static func createOrthographicCamera(
      left: Double, right: Double, top: Double, bottom: Double, near: Double, far: Double
    ) -> Int32 {
      three_createOrthographicCamera(
    ...
    public static func setRendererSize(
      _ renderID: Int32, width: Int32, height: Int32, pixelRatio: Double
    ) {
    ...
    public static func traverseScene(_ sceneID: Int32, meshBuffer: inout [Int32], bufferSize: Int32)
      -> Int32
    {
    ...
    public static func createShaderMaterial(
      vertexShader: String, fragmentShader: String, textureID: Int32
    ) -> Int32 {
      three_createShaderMaterial(
        vertexShader: vertexShader, fragmentShader: fragmentShader, textureID: textureID)
    }
